...
<#--    <script type="text/javascript" src="${ctx}/js/zTree_v3-3.5.32/js/jquery-1.4.4.min.js"></script>-->
    <script src="${ctx}/lib/jquery-3.4.1/jquery-3.4.1.min.js" type="text/javascript"></script>
